...
const CheckoutForm = () => {
    ...
    const [paybutton,setPayButton] = useState(true) //for only making enable if payment details is fully completed
    ...
    const handleSubmit = async (event) => {
        ...
        // debitcard ko details liyera token banaune kam hunxa jun createToken lai cardElemet le store garxa ani tyo token submit hunxa(yarn add @stripe/react-stripe-js @stripe/stripe-js) 
